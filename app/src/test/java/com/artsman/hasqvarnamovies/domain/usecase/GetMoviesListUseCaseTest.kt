...
class GetMoviesListUseCaseTest : ExpectSpec({
    ...
    expect("Given Next Page it must increment page number"){
        ...
        usecase.invoke(IGetMoviesList.Page.Start)
        usecase.invoke(IGetMoviesList.Page.Next)
        usecase.invoke(IGetMoviesList.Page.Next)
        coVerify {
